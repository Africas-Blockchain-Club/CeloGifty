...
// 						<button className={`p-1 rounded-md text-white border-none text-sm ${merchantAddress == account.address ? 'disabled bg-red-500' : 'bg-indigo-500'}`} onClick={(merchantAddress == account.address) ? () => { } : buy}>Buy Now</button>
// 					</div>
// 				</div>
// 			</div>
// 		</div>
