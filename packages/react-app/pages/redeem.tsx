	...
	return (<div className="min-h-screen w-screen">
		...
		<form className="max-w-sm mx-auto" onSubmit={redeem}>
			...
			<div className="flex  justify-center gap-x-2">
				<button className="group mt-10 flex w-40 items-center justify-center rounded-lg bg-red-700 py-4 text-center font-bold text-white transition" onClick={cancel}>
					Cancel
				</button>
				<button className="group mt-10 flex w-40 items-center justify-center rounded-lg bg-blue-700 py-4 text-center font-bold text-white transition" type="submit">
					Redeem
